    ...
    <div class="select-product-cat-wrapper">
        ...
        <div class="select-cat-step-wrapper">
            <div class="cat-step1" >
                ...
                <div class="panel panel-default pannel-outer-heading wcmp-categories-level-panel "> 
                        ...
                        <div class="wcmp-product-categories-wrap cat-column-wrapper">
                            <div class="wcmp-product-cat-level 1-level-cat cat-column" data-level="1"  data-mcs-theme="dark">
                                <ul class="wcmp-product-categories 1-level" data-cat-level="1">
                                 ...
                                 <!--label class="form-text">Select Category</label>
                                <select name="product_category" class="form-control wcmp-product-categories">
									<?php
										...
										{    
											...
											<?php
											echo ec_get_all_product_categories($term->term_id);
										}
									?>
                                </select-->
                            </div>
