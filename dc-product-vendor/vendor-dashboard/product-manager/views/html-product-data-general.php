    ...
    <div class="row-padding">
        ...
        if ( call_user_func_array( "wcmp_is_allowed_product_type", $pricing_visibility ) ) :
            ...
            <div class="form-group-row pricing <?php echo $show_classes; ?>"> 
                <div class="form-group">
                    <label class="control-label col-sm-3 col-md-3" for="_regular_price"><?php echo __( 'Retail Price', 'woocommerce' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
                    <div class="col-md-6 col-sm-9">
                        <input type="text" id="_regular_price" name="_regular_price" value="<?php echo $product_object->get_regular_price( 'edit' ); ?>" class="form-control required">
                    </div>
                </div>  
        ...
        if ( apply_filters( 'wcmp_can_vendor_configure_tax', wc_tax_enabled() ) && call_user_func_array( "wcmp_is_allowed_product_type", $tax_visibility ) ) :
            ...
            ?>
            <div class="form-group-row <?php echo $show_classes; ?> hide_me"> 
                <div class="form-group">
