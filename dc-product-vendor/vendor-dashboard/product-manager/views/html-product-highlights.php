...
<div class="cat-step3">
    <div class="panel-heading">
        <h1>
            ...
            <?php endif; ?>
            <?php _e( 'Add Artwork Details', 'dc-woocommerce-multi-vendor' );?>
        </h1>
        ...
        <div class="product-title-wrap <?php echo ( $self->is_spmv() || $is_update ) ? 'product-edit-mode' : 'product-add-mode'; ?>"> <!-- product-add-mode / product-edit-mode according to flow -->
            <div class="pull-left product-title-inner full-1080"> 
                <p class="pro-title">
                    <label><?php _e('Artwork Title', 'dc-woocommerce-multi-vendor'); ?>: </label>
                    ...
                    <span class="editing-content">
                        <input type="text" class="form-control required" name="post_title" id="post_title" value="<?php echo $product_object->get_title( 'edit' ); ?>"<?php if ( $self->is_spmv() && apply_filters('wcmp_singleproductmultiseller_edit_product_title_disabled', true) ) echo ' readonly="readonly"'; ?>>
            ...
            <div class="pull-right full-1080 hide_me">
                <?php
